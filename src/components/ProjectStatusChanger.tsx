...
export function ProjectStatusChanger({ projectId, currentStatus }: { projectId: number; currentStatus: string }) {
  ...
  return (
    <select value={currentStatus}
      ...
      className="min-h-[40px] text-sm bg-warm-100 dark:bg-warm-800 rounded-xl px-3 py-2 outline-none font-medium border border-warm-200 dark:border-warm-700 focus:border-sage-400 transition-colors">
